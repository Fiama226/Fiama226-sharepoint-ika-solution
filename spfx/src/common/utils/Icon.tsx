...
const REGISTRY: Record<string, PathSet[]> = {
  ...
  Clock: [C(12, 12, 10), S("M12 6v6l4 2")],
  ...
  Megaphone: [S("M4 10v4h4l8 4V6L8 10H4Z"), S("M18 9a3 3 0 0 1 0 6")],
  Briefcase: [S("M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"), R(2, 6, 20, 14, 2)],
  ...
  Award: [
    S("m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"),
    C(12, 8, 6),
  ],
  Star: [S("M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z")],
  ...
  // Bulle de conversation — verticale « messages Teams » de la recherche.
  MessageSquare: [S("M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z")],
  // `newspaper` était déjà référencé par NavigationService (ICON_BY_SLUG) sans
  // exister dans le registre : le rendu retombait silencieusement sur null.
  newspaper: [
    S("M4 4h13v16H4z"),
    S("M17 8h3v10a2 2 0 0 1-2 2"),
    S("M7 8h7M7 12h7M7 16h4"),
  ],
  ...
  ChevronsUpDown: [S("M7 15l5 5 5-5"), S("M7 9l5-5 5 5")],
